<div class="content-header">Administrator menu - Edit user</div>
...
<td><input type="text" placeholder="Enter login" name="login" id="login" value="<?php echo $user['login'] ?>"></td>
</tr>
...
<td><input type="first_name" placeholder="Enter first name" name="first_name" id="first_name" value="<?php echo $user['first_name'] ?>"></td>
<tr>

<tr>
<td><label for="last_name">Last name: </label></td>
<td><input type="last_name" placeholder="Enter last name" name="last_name" id="last_name" value="<?php echo $user['last_name'] ?>"></td>
<tr>

</table>
<input type="submit" value="Save user changes">
</form> 
</div>
</div>
