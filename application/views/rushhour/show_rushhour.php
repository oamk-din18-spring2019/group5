...
<body>
<a href="https://www.youtube.com/watch?v=JMiFsFQcFLE"><img src="<?php echo base_url('images/rushhour.jpg');?>" width="400px" height="550px" style="float:left"></a>
<?php
$query = $this->db->query('SELECT description, img_url, title from movies where Id=4');
